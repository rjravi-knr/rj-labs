...
const meta: Meta = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          'Breadcrumb navigation component for indicating the current page’s location within a navigational hierarchy. Supports links, separators, ellipsis, and accessibility best practices.',
      },
    },
  },
}
