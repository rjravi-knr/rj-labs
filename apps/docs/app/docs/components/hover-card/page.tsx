...
import { HoverCard, HoverCardContent, HoverCardTrigger } from "@labs/ui/hover-card"
    ...
    <div className="space-y-10">
      ...
      <div className="space-y-4">
        ...
        <div className="rounded-md bg-muted p-4">
          <code className="text-sm">import {"{ HoverCard, HoverCardContent, HoverCardTrigger }"} from "@labs/ui/hover-card"</code>
        </div>
      </div>
