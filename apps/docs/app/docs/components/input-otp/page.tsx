...
import { InputOTP, InputOTPGroup, InputOTPSlot } from "@labs/ui/input-otp"
    ...
    <div className="space-y-10">
      ...
      <div className="space-y-4">
        ...
        <div className="rounded-md bg-muted p-4">
          <code className="text-sm">import {"{ InputOTP, InputOTPGroup, InputOTPSlot }"} from "@labs/ui/input-otp"</code>
        </div>
      </div>
