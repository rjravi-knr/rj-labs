...
import { Tooltip, TooltipContent, TooltipProvider, TooltipTrigger } from "@labs/ui/tooltip"
    ...
    <div className="space-y-10">
      ...
      <div className="space-y-4">
        ...
        <div className="rounded-md bg-muted p-4">
          <code className="text-sm">import {"{ Tooltip, TooltipContent, TooltipProvider, TooltipTrigger }"} from "@labs/ui/tooltip"</code>
        </div>
      </div>
