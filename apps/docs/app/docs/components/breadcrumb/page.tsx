  ...
  return (
    <div className="space-y-10">
      <div className="space-y-2">
        <h1 className="scroll-m-20 text-4xl font-bold tracking-tight">Breadcrumb</h1>
      ...
      <div className="space-y-4">
        ...
        <div className="rounded-md bg-muted p-4">
          <code className="text-sm">import {"{ Breadcrumb, BreadcrumbItem, BreadcrumbLink, BreadcrumbList, BreadcrumbPage, BreadcrumbSeparator }"} from "@labs/ui/breadcrumb"</code>
        </div>
      </div>
